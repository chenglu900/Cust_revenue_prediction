...
PATH = "/Users/ChengLu/Desktop/DS/Kaggle/Data/"
NUM_ROUNDS = 20000
VERBOSE_EVAL = 500
STOP_ROUNDS = 100
N_SPLITS = 10
...
test_df[0:100, :].to_csv("check_test_df_before_getdummy.csv", index=False)
...
test_df[0:100, :].to_csv("check_test_df_before_labelencoder.csv", index=False)
...
test_df[0:100, :].to_csv("check_test_df_after_labelencoder.csv", index=False)
...
## change 1: predictions_lgb[predictions_lgb<0] = 0  
predictions_lgb[predictions_lgb<0.1] = 0   ## changed at Oct-27-2018
